...
with tab7:
    ...
    DATASETS = [
        ...
        {"name": "CMS Medicare Geographic Variation", "agency": "CMS", "category": "Medicare Spending", "years": "2014–2023", "year_start": 2014, "year_end": 2023, "granularity": "State / County / National", "measures": "Medicare FFS spending, beneficiary counts, and 200+ service-line breakdowns including utilization and quality.", "rows": 33639},
        {"name": "CMS Medicare Monthly Enrollment", "agency": "CMS", "category": "Medicare Enrollment", "years": "2013–2025", "year_start": 2013, "year_end": 2025, "granularity": "State", "measures": "Part D, dual eligibility, and ESRD enrollment counts (additive fields only, no overlap with Geographic Variation).", "rows": 9802},
        {"name": "CMS Medicare Inpatient by Geography & Service", "agency": "CMS", "category": "Hospital Spending", "years": "2023", "year_start": 2023, "year_end": 2023, "granularity": "State × DRG", "measures": "Medicare inpatient discharges, average submitted charges, and payment amounts by state and DRG.", "rows": 26479},
        {"name": "CMS Medicare Physician & Other Practitioners", "agency": "CMS", "category": "Medicare Spending", "years": "2023", "year_start": 2023, "year_end": 2023, "granularity": "State × HCPCS", "measures": "Medicare physician services, providers, beneficiaries, and payments by HCPCS code and place of service.", "rows": 268634},
        {"name": "CMS Medicare Part D Prescribers (state × specialty)", "agency": "CMS", "category": "Prescribing Patterns", "years": "2023", "year_start": 2023, "year_end": 2023, "granularity": "State × Specialty", "measures": "Part D prescribing volume, cost, opioid/brand/generic shares aggregated to state and provider specialty.", "rows": 5299},
        {"name": "Medicare Part D Drug Spending", "agency": "CMS", "category": "Medicare Spending", "years": "Multi-year", "year_start": 2018, "year_end": 2025, "granularity": "Drug × Year", "measures": "Annual Medicare Part D spending and beneficiary counts by drug.", "rows": 28255},
        {"name": "Medicare Part B Drug Spending", "agency": "CMS", "category": "Medicare Spending", "years": "Multi-year", "year_start": 2018, "year_end": 2023, "granularity": "HCPCS × Year", "measures": "Annual Medicare Part B physician-administered drug spending by HCPCS code.", "rows": 734},
        {"name": "CMS Chronic Conditions Prevalence", "agency": "CMS", "category": "Disease Burden", "years": "Multi-year", "year_start": 2017, "year_end": 2022, "granularity": "State × Sex × Age", "measures": "Beneficiary-level prevalence rates for the 21 CMS-tracked chronic conditions.", "rows": 83160},
        {"name": "CMS Open Payments (state-aggregated)", "agency": "CMS", "category": "Industry Payments", "years": "2023", "year_start": 2023, "year_end": 2023, "granularity": "State", "measures": "Pharmaceutical/device manufacturer payments to physicians and teaching hospitals; $3.31B total in 2023.", "rows": 60},

        # CMS — Hospital quality & facilities (10–19)
        {"name": "Hospital Compare — HCAHPS State", "agency": "CMS", "category": "Hospital Quality", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "State", "measures": "Patient satisfaction (HCAHPS top-box %) by state across 12 dimensions.", "rows": 2856},
        {"name": "Hospital Compare — Unplanned Visits State", "agency": "CMS", "category": "Hospital Quality", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "State", "measures": "Distribution of hospitals on readmission and ED-visit measures (worse / same / better than national).", "rows": 784},
        {"name": "Hospital Compare — Complications & Deaths State", "agency": "CMS", "category": "Hospital Quality", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "State", "measures": "Distribution of hospitals on PSI-90, surgical complications, and 30-day mortality measures.", "rows": 1120},
        {"name": "Hospital Compare — General Info", "agency": "CMS", "category": "Hospital Quality", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "Facility", "measures": "Hospital roster with overall 1–5★ rating, ownership, and per-domain measure counts.", "rows": 5426},
        {"name": "CMS Nursing Home Provider Information", "agency": "CMS", "category": "Long-term Care", "years": "Mar 2026 snapshot", "year_start": 2026, "year_end": 2026, "granularity": "Facility", "measures": "Nursing home identity, beds, 5-star ratings, staffing hours per resident, deficiencies, and penalties.", "rows": 14703},
        {"name": "CMS Home Health Care Agencies", "agency": "CMS", "category": "Long-term Care", "years": "Apr 2026 snapshot", "year_start": 2026, "year_end": 2026, "granularity": "Facility", "measures": "Home health agency services, 5-star quality rating, and process measures (timely care, flu vax, falls).", "rows": 12392},
        {"name": "CMS Hospice Provider Information", "agency": "CMS", "category": "Long-term Care", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "Facility", "measures": "Hospice provider info, CAHPS Hospice Survey scores, HQRP star rating, family caregiver experience.", "rows": 6943},
        {"name": "CMS Dialysis Facility Compare", "agency": "CMS", "category": "Long-term Care", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "Facility", "measures": "ESRD facility 5-star rating, transplant waitlist %, hospitalization rate, vascular access type, fluid management.", "rows": 7557},
        {"name": "CMS Hospital Price Transparency Enforcement", "agency": "CMS", "category": "Hospital Pricing", "years": "Multi-year", "year_start": 2021, "year_end": 2025, "granularity": "Facility action", "measures": "CMS notices and enforcement actions against hospitals under the price transparency rule.", "rows": 10726},
        {"name": "CMS Medicare Advantage Star Ratings", "agency": "CMS", "category": "Insurance Quality", "years": "Multi-year", "year_start": 2020, "year_end": 2025, "granularity": "Contract", "measures": "Medicare Advantage / PDP plan 1–5★ quality ratings on Part C, Part D, and overall composite.", "rows": 2415},

        # CMS — Programs (20–22)
        {"name": "CMS Medicare Shared Savings ACOs", "agency": "CMS", "category": "Accountable Care", "years": "Multi-year", "year_start": 2013, "year_end": 2024, "granularity": "ACO", "measures": "Shared Savings Program ACO assigned beneficiaries, benchmarks, savings/losses, and quality scores.", "rows": 5001},
        {"name": "CMS Innovation Center (CMMI) Model Participants", "agency": "CMS", "category": "Payment Models", "years": "Feb 2026 snapshot", "year_start": 2026, "year_end": 2026, "granularity": "Organization × Model", "measures": "Active CMMI alternative payment model participants across 17 models (PCF, MD TCOC, BPCI, ACO REACH).", "rows": 3498},
        {"name": "CMS Medicaid State Drug Utilization", "agency": "CMS", "category": "Medicaid Spending", "years": "Multi-year", "year_start": 2018, "year_end": 2024, "granularity": "State", "measures": "Medicaid prescription utilization, total reimbursement, and Medicaid-vs-non-Medicaid splits by state.", "rows": 522},

        # HRSA (23–34)
        {"name": "HRSA Area Health Resources File (AHRF)", "agency": "HRSA", "category": "Workforce", "years": "2024–2025", "year_start": 2023, "year_end": 2024, "granularity": "State + National", "measures": "Health workforce supply by profession (physicians, RNs, dentists, PAs), with population denominators.", "rows": 52},
        {"name": "HPSA — Primary Care", "agency": "HRSA", "category": "Provider Shortage", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "HPSA designation", "measures": "Primary care HPSA designations: score, FTEs needed, designated population, lat/lon, county FIPS.", "rows": 77724},
        {"name": "HPSA — Dental", "agency": "HRSA", "category": "Provider Shortage", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "HPSA designation", "measures": "Dental HPSA designations using the same schema as Primary Care.", "rows": 45176},
        {"name": "HPSA — Mental Health", "agency": "HRSA", "category": "Provider Shortage", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "HPSA designation", "measures": "Mental health HPSA designations using the same schema as Primary Care.", "rows": 39517},
        {"name": "HRSA FQHC Site Roster", "agency": "HRSA", "category": "Health Centers", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "Facility", "measures": "FQHC and Look-Alike service-delivery sites with locations, hours, and county/region/district codes.", "rows": 18880},
        {"name": "HRSA UDS — FQHC Patients Served (cleaned)", "agency": "HRSA", "category": "Health Centers", "years": "2024", "year_start": 2024, "year_end": 2024, "granularity": "Health center awardee", "measures": "FQHC awardee patients served, demographics, insurance mix, and visit counts (32.4M total patients).", "rows": 1359},
        {"name": "HRSA UDS — H80 raw archive", "agency": "HRSA", "category": "Health Centers", "years": "2024", "year_start": 2024, "year_end": 2024, "granularity": "Health center awardee", "measures": "Full UDS reporting workbook with 37 source tables (chronic conditions, procedures, financials).", "rows": 37},
        {"name": "HRSA Grants", "agency": "HRSA", "category": "Federal Grants", "years": "Multi-year", "year_start": 2010, "year_end": 2025, "granularity": "Grantee", "measures": "Federal financial assistance awarded by HRSA (Health Centers, MCH, Workforce, Ryan White, etc.).", "rows": 114289},
        {"name": "HRSA Maternal & Child Health (Title V)", "agency": "HRSA", "category": "Maternal/Child Health", "years": "Multi-year", "year_start": 2014, "year_end": 2024, "granularity": "State × Measure × Stratifier", "measures": "Title V National Performance and Outcome Measures across the MCH lifecourse.", "rows": 630430},
        {"name": "HRSA Ryan White HIV/AIDS Program", "agency": "HRSA", "category": "HIV/AIDS", "years": "Current", "year_start": 2024, "year_end": 2025, "granularity": "Recipient", "measures": "Ryan White recipients and sub-recipients with HAB Provider Type and indicators for Parts A–F funding.", "rows": 2200},
        {"name": "HRSA Telehealth (Medicare beneficiary)", "agency": "HRSA", "category": "Telehealth", "years": "Multi-year", "year_start": 2020, "year_end": 2024, "granularity": "Quarter × Beneficiary stratification", "measures": "Medicare telehealth utilization rates broken out by demographics and Medicaid/Medicare enrollment status.", "rows": 33712},
        {"name": "HRSA Workforce Projections", "agency": "HRSA", "category": "Workforce", "years": "Long horizon", "year_start": 2020, "year_end": 2037, "granularity": "State × Profession × Rurality", "measures": "Modeled supply, demand, and shortage projections for ~30 health professions under multiple scenarios.", "rows": 102528},

        # CDC (35–50)
        {"name": "CDC NCHS Leading Causes of Death", "agency": "CDC", "category": "Mortality", "years": "1999–2017", "year_start": 1999, "year_end": 2017, "granularity": "State × Cause", "measures": "Age-adjusted death rate and counts by state and cause (11 leading causes + all-causes).", "rows": 10868},
        {"name": "CDC Mortality 2018–2023 (extends NCHS)", "agency": "CDC", "category": "Mortality", "years": "2018–2023", "year_start": 2018, "year_end": 2023, "granularity": "State × Cause", "measures": "Crude death rate per 100k and counts by state and cause; fills the 2018+ gap left by the NCHS file.", "rows": 4644},
        {"name": "CDC PLACES — County Chronic Disease", "agency": "CDC", "category": "Disease Burden", "years": "2022–2023", "year_start": 2022, "year_end": 2023, "granularity": "County", "measures": "Model-based small-area chronic disease prevalence across 40 measures and 6 categories.", "rows": 229298},
        {"name": "CDC BRFSS Prevalence", "agency": "CDC", "category": "Disease Burden", "years": "2018–2024", "year_start": 2018, "year_end": 2024, "granularity": "State", "measures": "State-level chronic disease prevalence across 21 classes and 63 topics.", "rows": 64290},
        {"name": "CDC VSRR — Drug Overdose Deaths", "agency": "CDC", "category": "Mortality", "years": "2015–2025", "year_start": 2015, "year_end": 2025, "granularity": "State (monthly)", "measures": "Provisional drug overdose death counts by state, month, and 12 drug-class indicators.", "rows": 82530},
        {"name": "CDC Births / Natality", "agency": "CDC", "category": "Maternal/Child Health", "years": "Multi-year", "year_start": 2014, "year_end": 2023, "granularity": "State", "measures": "State-level fertility rate, total births, % preterm, % low-birthweight.", "rows": 502},
        {"name": "CDC Maternal Mortality", "agency": "CDC", "category": "Maternal/Child Health", "years": "Multi-period", "year_start": 2018, "year_end": 2023, "granularity": "State", "measures": "Maternal death counts and rates per 100k live births over rolling multi-year periods.", "rows": 260},
        {"name": "CDC HIV Surveillance", "agency": "CDC", "category": "Communicable Disease", "years": "Multi-year", "year_start": 2008, "year_end": 2023, "granularity": "State", "measures": "New HIV diagnosis rates per 100k and case counts by state, with sex and demographic stratifications.", "rows": 832},
        {"name": "CDC STI Surveillance", "agency": "CDC", "category": "Communicable Disease", "years": "Multi-year", "year_start": 2017, "year_end": 2024, "granularity": "State (weekly)", "measures": "Reported chlamydia, gonorrhea, syphilis, and congenital syphilis cases by jurisdiction and week.", "rows": 1918},
        {"name": "CDC Childhood Lead Exposure (CBLPP)", "agency": "CDC", "category": "Environmental Health", "years": "Multi-year", "year_start": 2018, "year_end": 2022, "granularity": "State", "measures": "Children <72 months tested for lead and counts/percentages above 3.5/5/10/25/45 µg/dL thresholds.", "rows": 198},
        {"name": "CDC Oral Health (NOHSS)", "agency": "CDC", "category": "Oral Health", "years": "Multi-year", "year_start": 2010, "year_end": 2024, "granularity": "State × Indicator", "measures": "Adult dental visits, edentulism, water fluoridation %, sealant prevalence, caries.", "rows": 34332},
        {"name": "CDC NHANES Summary Estimates", "agency": "CDC", "category": "Health Surveillance", "years": "Multi-cycle", "year_start": 2015, "year_end": 2023, "granularity": "National", "measures": "Pre-aggregated NHANES estimates for biomarkers, nutrition, body measurements, dental, vision.", "rows": 6072},
        {"name": "CDC Social Vulnerability Index (SVI)", "agency": "CDC", "category": "Social Determinants", "years": "2022", "year_start": 2022, "year_end": 2022, "granularity": "County", "measures": "Composite social vulnerability percentile and 4 thematic subscores plus 16 underlying indicators.", "rows": 3144},
        {"name": "CDC WISQARS — Injury Surveillance", "agency": "CDC", "category": "Injury", "years": "Multi-year", "year_start": 2018, "year_end": 2023, "granularity": "National (quarterly)", "measures": "Injury and violent death rates (homicide, suicide, unintentional) with demographic stratifications.", "rows": 840},
        {"name": "CDC National Wastewater Surveillance (NWSS)", "agency": "CDC", "category": "Surveillance", "years": "Recent", "year_start": 2022, "year_end": 2025, "granularity": "State (weekly)", "measures": "Population-weighted wastewater concentrations for SARS-CoV-2, flu, RSV, mpox by state and week.", "rows": 27761},
        {"name": "CDC Vaccination Coverage (combined)", "agency": "CDC", "category": "Immunization", "years": "2015–2025", "year_start": 2015, "year_end": 2025, "granularity": "State × Vaccine type", "measures": "Coverage rates with 95% CI for flu (FluVaxView), childhood (NIS-Child), teen (NIS-Teen), and COVID-19.", "rows": 252883},

        # Other federal health agencies (51–58)
        {"name": "AHRQ MEPS (Insurance + Household)", "agency": "AHRQ", "category": "Insurance", "years": "Multi-year", "year_start": 2015, "year_end": 2023, "granularity": "State", "measures": "Employer-sponsored insurance estimates (premium, contribution, take-up) and household expenditure data.", "rows": 32793},
        {"name": "NCI / CDC US Cancer Statistics", "agency": "NCI/CDC", "category": "Cancer", "years": "1999–2023", "year_start": 1999, "year_end": 2023, "granularity": "State × Site × Race × Sex", "measures": "Cancer incidence and mortality with age-adjusted rates and confidence intervals; 27 cancer sites.", "rows": 1140819},
        {"name": "NIH RePORTER Research Funding", "agency": "NIH", "category": "Research Funding", "years": "FY 2020–2024", "year_start": 2020, "year_end": 2024, "granularity": "State × NIH Institute", "measures": "NIH research grant dollars and project counts by state and NIH Institute (NCI, NIA, NHLBI, etc.).", "rows": 7243},
        {"name": "NIMH Mental Health Indicators", "agency": "NIMH", "category": "Mental Health", "years": "Pandemic-era", "year_start": 2020, "year_end": 2024, "granularity": "State", "measures": "Anxiety/depression symptom prevalence, mental health treatment access and unmet need.", "rows": 16794},
        {"name": "ONC / ASTP Hospital Health IT Adoption", "agency": "ONC/ASTP", "category": "Health IT", "years": "2008–2020", "year_start": 2008, "year_end": 2020, "granularity": "State + National", "measures": "Hospital EHR adoption % (CEHRT), interoperability, HIE participation, and patient engagement metrics.", "rows": 624},
        {"name": "FDA Adverse Events (FAERS summary)", "agency": "FDA", "category": "Pharmacovigilance", "years": "Multi-year", "year_start": 2015, "year_end": 2024, "granularity": "National", "measures": "Annual FAERS report counts by indicator (serious / non-serious / death / hospitalization).", "rows": 288},
        {"name": "SAMHSA FindTreatment.gov Facilities", "agency": "SAMHSA", "category": "Behavioral Health", "years": "Current", "year_start": 2025, "year_end": 2025, "granularity": "Facility", "measures": "Substance use and mental health treatment facilities with services, payment, and program flags.", "rows": 87549},
        {"name": "SAMHSA NSDUH State Estimates", "agency": "SAMHSA", "category": "Behavioral Health", "years": "Multi-period", "year_start": 2018, "year_end": 2023, "granularity": "State", "measures": "Substance use, mental illness prevalence, and treatment receipt with 95% CIs.", "rows": 10136},

        # Workforce / Occupational (59–61)
        {"name": "BLS OES Healthcare Wages", "agency": "BLS", "category": "Workforce", "years": "May 2024", "year_start": 2024, "year_end": 2024, "granularity": "State × SOC", "measures": "Healthcare occupation employment counts and wage percentiles (10/25/50/75/90).", "rows": 4136},
        {"name": "GME Residency Programs", "agency": "Public/AAMC", "category": "Workforce", "years": "Multi-year", "year_start": 2018, "year_end": 2024, "granularity": "State", "measures": "Counts of teaching hospitals, resident FTEs, total hospitals, and beds by state.", "rows": 275},
        {"name": "OSHA Healthcare Injuries (SOII)", "agency": "OSHA/BLS", "category": "Workforce Safety", "years": "Multi-year", "year_start": 2018, "year_end": 2023, "granularity": "State × NAICS", "measures": "Recordable injury and illness rates per 100 FTE in healthcare industries (hospitals, NF, ambulatory).", "rows": 2892},

        # Census (62–64)
        {"name": "Census ACS Demographics (5-year)", "agency": "Census", "category": "Demographics", "years": "2019–2023", "year_start": 2019, "year_end": 2023, "granularity": "State", "measures": "Total population, median household income, education attainment, disability subcomponents.", "rows": 52},
        {"name": "Census SAHIE — Insurance Estimates", "agency": "Census", "category": "Insurance", "years": "2006–2023", "year_start": 2006, "year_end": 2023, "granularity": "State × IPR bracket", "measures": "% uninsured and insured by state and income-to-poverty bracket; supports income-stratified analysis.", "rows": 4998},
        {"name": "Census SAIPE — Income & Poverty", "agency": "Census", "category": "Income/Poverty", "years": "2003–2023", "year_start": 2003, "year_end": 2023, "granularity": "County + State", "measures": "Poverty rate (all ages and 0–17), median household income, count in poverty.", "rows": 67059},

        # Social determinants & infrastructure (65–72)
        {"name": "EPA EJSCREEN — Environmental Justice", "agency": "EPA", "category": "Environmental Health", "years": "Multi-year", "year_start": 2020, "year_end": 2024, "granularity": "County", "measures": "Environmental burden indicators: PM2.5, ozone, diesel PM, traffic proximity, lead paint risk.", "rows": 32133},
        {"name": "USDA Food Access Research Atlas", "agency": "USDA", "category": "Social Determinants", "years": "2019", "year_start": 2019, "year_end": 2019, "granularity": "Census tract", "measures": "Food desert flags (Low-Income + Low-Access at 0.5/1/10/20-mile thresholds), distance, vehicle access.", "rows": 72531},
        {"name": "USDA WIC Program", "agency": "USDA", "category": "Nutrition", "years": "FY 2021–2025", "year_start": 2021, "year_end": 2025, "granularity": "State", "measures": "WIC participation (women/infants/children breakouts), food cost, NSA cost, total program cost.", "rows": 275},
        {"name": "HUD Fair Market Rents", "agency": "HUD", "category": "Housing", "years": "FY 2026", "year_start": 2026, "year_end": 2026, "granularity": "County / FMR area", "measures": "40th-percentile fair market rent for 0/1/2/3/4-bedroom units by HUD area.", "rows": 4764},
        {"name": "DOT Transportation Infrastructure", "agency": "DOT", "category": "Transportation", "years": "Current", "year_start": 2024, "year_end": 2024, "granularity": "County", "measures": "Counts of airports, public airfields, bridges, transit stations, and highway miles by county.", "rows": 3142},
        {"name": "FCC Broadband Availability", "agency": "FCC", "category": "Broadband Infrastructure", "years": "June 2024", "year_start": 2024, "year_end": 2024, "granularity": "County", "measures": "Broadband availability at 25/3 and 100/20 Mbps thresholds, per-tech splits, unique provider counts.", "rows": 3234},
        {"name": "AoA / ACL Aging Services (NAPIS)", "agency": "ACL", "category": "Aging Services", "years": "Multi-year", "year_start": 2015, "year_end": 2023, "granularity": "State", "measures": "Older Americans Act services: nutrition, transportation, supportive services, caregiver, expenditures.", "rows": 610},
        {"name": "RWJF County Health Rankings", "agency": "RWJF", "category": "Population Health", "years": "Annual", "year_start": 2010, "year_end": 2024, "granularity": "County", "measures": "Composite county health rankings (Outcomes + Factors) plus ~390 underlying measures.", "rows": 3205},

        # State-specific (73)
        {"name": "California HCAI Hospital Utilization", "agency": "CA HCAI", "category": "Hospital Utilization", "years": "2012–2017", "year_start": 2012, "year_end": 2017, "granularity": "Facility (CA only)", "measures": "California hospital annual utilization measures, characteristics, and administrative geography.", "rows": 226902},
    ]
    ...
    col_k1.metric("Datasets", f"{len(df_sources):,}")
    col_k2.metric("Total Rows", f"{df_sources['rows'].sum():,}")
    col_k3.metric("Agencies", f"{df_sources['agency'].nunique()}")
    col_k4.metric(
        "Year Span",
        f"{int(df_sources['year_start'].min())}–{int(df_sources['year_end'].max())}",
    )
    ...
    search_q = col_f1.text_input("Search (matches name, agency, category, or description)", "", key="ds_search")
    agency_filter = col_f2.multiselect(
        "Agency",
        options=sorted(df_sources["agency"].unique().tolist()),
        key="ds_agency",
    )
    category_filter = col_f3.multiselect(
        "Category",
        options=sorted(df_sources["category"].unique().tolist()),
        key="ds_category",
    )
    ...
    if search_q:
        ...
        mask = (
            ...
            | filtered_sources["measures"].str.lower().str.contains(q, na=False)
        )
        filtered_sources = filtered_sources[mask]
    if agency_filter:
        filtered_sources = filtered_sources[filtered_sources["agency"].isin(agency_filter)]
    if category_filter:
        filtered_sources = filtered_sources[filtered_sources["category"].isin(category_filter)]

    st.markdown(f"**Showing {len(filtered_sources)} of {len(df_sources)} datasets.**")

    display = filtered_sources[
        ["name", "agency", "category", "years", "granularity", "measures", "rows"]
    ].rename(columns={
        "name": "Dataset",
        "agency": "Agency",
        "category": "Category",
    ...
    st.dataframe(
        ...
        column_config={
            ...
            "What It Measures": st.column_config.TextColumn("What It Measures", width="large"),
        },
    )
    st.download_button(
